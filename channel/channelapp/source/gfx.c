...
void gfx_init() {
    ...
    // the 0.05 fudge factors for some reason help align textures on the pixel
    // grid it's still not perfect though
    ...
    guOrtho(p, view_height / 2, -(view_height / 2), -(view_width / 2),
            view_width / 2, 100, 1000);
...
void gfx_set_efb_buffer(u32 *buffer) { efb_buffer = buffer; }

// entity generators

void gfx_gen_gradient(gfx_entity *entity, u16 w, u16 h, u32 c1, u32 c2, u32 c3,
                      u32 c4) {
...
void gfx_gen_tex(gfx_entity *entity, u16 w, u16 h, u8 *pixels,
                 gfx_tex_type type) {
