...
static void bn_zero(u8 *d, u32 n) { memset(d, 0, n); }

static void bn_copy(u8 *d, const u8 *a, u32 n) { memcpy(d, a, n); }
...
static void bn_exp(u8 *d, const u8 *a, const u8 *N, u32 n, const u8 *e,
                   u32 en) {
    u8 t[512];
    u32 i;
    u8 mask;
...
static void elt_copy(u8 *d, const u8 *a) { memcpy(d, a, 30); }

static void elt_zero(u8 *d) { memset(d, 0, 30); }
