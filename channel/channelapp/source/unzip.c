...
static int unzlocal_getByte OF((const zlib_filefunc_def *pzlib_filefunc_def,
                                voidpf filestream, int *pi));

static int unzlocal_getByte(pzlib_filefunc_def, filestream,
...
*/
static int unzlocal_getShort OF((const zlib_filefunc_def *pzlib_filefunc_def,
                                 voidpf filestream, uLong *pX));

static int unzlocal_getShort(pzlib_filefunc_def, filestream,
...
static int unzlocal_getLong OF((const zlib_filefunc_def *pzlib_filefunc_def,
                                voidpf filestream, uLong *pX));

static int unzlocal_getLong(pzlib_filefunc_def, filestream,
                            pX) const zlib_filefunc_def *pzlib_filefunc_def;
voidpf filestream;
uLong *pX;
{
...
static int strcmpcasenosensitive_internal(fileName1, fileName2) const
    char *fileName1;
...
static uLong unzlocal_SearchCentralDir(pzlib_filefunc_def, filestream) const
...
*/
extern unzFile ZEXPORT unzOpen(buffer, buf_len) void *buffer;
size_t buf_len;
{
    unz_s us;
    unz_s *s;
    ...
    us.filestream = (*(us.z_filefunc.zopen_file))(
        us.z_filefunc.opaque, buffer, buf_len,
...
*/
static void unzlocal_DosDateToTmuDate(ulDosDate, ptm) uLong ulDosDate;
tm_unz *ptm;
{
    uLong uDate;
...
static int unzlocal_GetCurrentFileInfoInternal(file, pfile_info,
